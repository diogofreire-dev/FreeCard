...
-- Descomenta para inserir dados de teste
-- =====================================================
...
- Estrutura inicial: users, cards, transactions, user_settings
- Sistema de autenticação
- Gestão de cartões e transações
- Sistema de temas (claro/escuro)
- Orçamentos e alertas

Versão 1.1.0 (Janeiro 2025)
- Adicionados campos de segurança em users:
  * last_password_change
  * last_email_change
  * two_factor_enabled
  * two_factor_secret
- Implementada limitação de 30 dias para alteração de password/email
- Preparação para autenticação 2FA (futura implementação)
